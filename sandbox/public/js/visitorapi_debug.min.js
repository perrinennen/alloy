...
var e = (function() {
  ...
  function d() {
    ...
    var m = u(
      ...
      S = {},
      b = (function(e, t) {
        return Ie(e) || (t && Ie(t)) ? oe.COMPLETE : oe.PENDING;
      })(v, D),
      A = (function(e, t, n) {
        var i = he(ce, !r);
    ...
    (h.deny = n(!1)),
      (h.approve = n(!0)),
      (h.denyAll = h.deny.bind(h, ce)),
      (h.approveAll = h.approve.bind(h, ce)),
      ...
      (t.isApproved = function(e) {
        ...
        if (i.allConsentData)
          return t(
            ...
            l(
              n,
              i.allConsentData.vendorConsents,
              i.allConsentData.purposeConsents
            )
          );
        var o = f(function(e) {
          var i =
            ...
            o(function() {
              var e =
                arguments.length > 0 && void 0 !== arguments[0]
                  ...
                  : {};
              (arguments.length > 1 ? arguments[1] : void 0) &&
                ((a.consentString = e.consentData), r("allConsentData", a)),
  ...
  var h,
    ...
    G = function(e, t, n, i) {
      ...
      function l() {
        r(new E(n._generateID)),
          ...
          m.removeEventListener("message", u);
      }
      function u(e) {
        if (!_.isInvalid(e)) {
          var t = _.parse(e);
    ...
    X = function(e, t) {
      ...
      return function(e) {
        if (!t.isInvalid(e)) {
          (t.parse(e).prefix === B.HANDSHAKE ? o : s)(e.source);
        }
      };
    },
    z = function(e, t) {
    ...
    J = function(e) {
      var t;
      if ((!e && m.location && (e = m.location.hostname), (t = e)))
        if (/^[0-9.]+$/.test(t)) t = "";
        else {
          var n =
      ...
      receiveMessage: function(e, t) {
        ...
        try {
          Q &&
            ...
            m.addEventListener
              ? m[e ? "addEventListener" : "removeEventListener"]("message", n)
              : m[e ? "attachEvent" : "detachEvent"]("onmessage", n));
        } catch (e) {}
      }
    },
    Z = function(e) {
      ...
      return {
        ...
        getCORSInstance: function() {
          return "none" === this.corsMetadata.corsType
            ? null
            : new m[this.corsMetadata.corsType]();
        },
        fireCORS: function(n, i, r) {
          function a(e) {
            ...
            try {
              if ((t = JSON.parse(e)) !== Object(t))
                return void o.handleCORSError(n, null, "Response is not JSON");
            } catch (e) {
            ...
            try {
              for (var i = n.callback, r = m, a = 0; a < i.length; a++)
                r = r[i[a]];
              r(t);
            } catch (e) {
          ...
          try {
            ...
            s.open("get", n.corsUrl + "&ts=" + new Date().getTime(), !0),
              "XMLHttpRequest" === this.corsMetadata.corsType &&
                ((s.withCredentials = !0),
                (s.timeout = e.loadTimeout),
                s.setRequestHeader(
                  "Content-Type",
      ...
      return {
        ...
        checkFirstPartyCookie: function(t, n, i) {
          ...
          var o,
            ...
            u = !1,
            c = !1,
            d = Math.ceil(new Date().getTime() / te.MILLIS_PER_DAY);
          l
            ? ((o = l.split("*")),
              (s = this.pruneSyncData(o, t.id, d)),
              (u = s.dataPresent),
              (c = s.dataValid),
              (u && c) || this.fireSync(r, t, n, o, a, d))
        ...
        canMakeSyncIDCall: function(t, n) {
          return (
            e._forceSyncIDCall || !t || n - t > te.DAYS_BETWEEN_SYNC_ID_CALLS
          );
        },
    ...
    le = ((h = {}), t(h, se.AAM, 565), t(h, se.ECID, 565), h),
    ue = ((_ = {}), t(_, se.AAM, [1, 2, 5]), t(_, se.ECID, [1, 2, 5]), _),
    ce = (function(e) {
    ...
    ye = function(e, t) {
      if (!Ie(e)) throw new Error("[OptIn] ".concat(t));
    },
    Oe = function(e) {
      return Object.keys(e).map(function(t) {
        return e[t];
  ...
  (d.Categories = se), (d.TimeoutError = c);
  var Le = function() {
    ...
    we = {
      ...
      set: function(e, t, n) {
        ...
        if (r && "SESSION" !== i && "NONE" !== i) {
          ...
          if (o) (r = new Date()), r.setTime(r.getTime() + 1e3 * o);
          else if (1 === r) {
            r = new Date();
            var s = r.getYear();
    ...
    je = Pe.OptIn;
  x.defineGlobalNamespace(), (window.adobe.OptInCategories = je.Categories);
  var xe = function(t, n, i) {
    ...
    function a(e) {
      ...
      t(e[v], d.setMarketingCloudVisitorID),
    ...
    function u() {
      return !!d.configs.doesOptInApply && !(f.optIn.isComplete && c());
    }
    function c() {
    ...
    (d.FIELDS = M.FIELDS),
        ...
        for (e in d._currentCustomerIDs)
          O(e) &&
            ...
            void 0 != t.authState
              ...
              : (n[e].authState = _.AuthState.UNKNOWN));
        return n;
      }),
      ...
      (d.getAnalyticsVisitorID = function(e, t, n) {
        ...
        if (
          ...
          return (o.url = a), d._getRemoteField(n ? v : S, a, e, t, o);
        }
        return "";
      }),
        ...
        if (
          ...
          if (
            ...
            var i = d._getAudienceManagerURLData(),
              r = i.url;
            return (
              d._customerIDsHashChanged && d._setFieldExpire(A, -1),
    ...
    (d._liberatedOptOut = null),
      (d.getOptOut = function(e, t) {
        var n = d._getAudienceManagerURLData("_setMarketingCloudFields"),
          i = n.url;
        if (c()) return d._getRemoteField("MCOPTOUT", i, e, t, n);
        if (
          (d._registerCallback("liberatedOptOut", e),
      ...
      (d._addQuerystringParam = function(e, t, n, i) {
        ...
        var s = o.split("?"),
          l = s[0] + "?",
          u = s[1];
        return l + T.addQueryParamAtLocation(u, r, i) + a;
      }),
      ...
      (d._appendVersionTo = function(e) {
        ...
        return (
          n
            ? K.areVersionsDifferent(n, d.version) &&
      ...
      (d._setFields = function(t, n) {
        if (
          ...
          P.fieldGroupObj[t] &&
            ((P.fieldGroupObj[t].requestEnd = P.millis()), P.process(t)),
          ...
          if (!i || d.overwriteCrossDomainMCIDAndAID) {
            if (
              !(i = "object" === e(n) && n.mid ? n.mid : d._findVisitorID(n))
            ) {
              if (
        ...
        if (n === Object(n)) {
          var u, f;
          c() && d.isAllowed() && (u = d._getField("MCOPTOUT"));
          var g = x.parseOptOut(n, u, y);
          (u = g.optOut),
            (f = g.d_ottl),
            d._setFieldExpire("MCOPTOUT", f, !0),
            d._setField("MCOPTOUT", u),
            d._callAllCallbacks("MCOPTOUT", [u]);
        }
      }),
      (d._loading = null),
      (d._getRemoteField = function(e, t, n, i, r) {
        var a,
          o = "",
          s = T.isFirstPartyAnalyticsVisitorIDCall(e),
          l = {
            MCAAMLH: !0,
            MCAAMB: !0
          };
                ...
                !t ||
                  ...
                  d._loadData(
                    ...
                    function(t) {
                      if (!d._getField(e)) {
                        P.fieldGroupObj[a] &&
                          ((P.fieldGroupObj[a].timeout = P.millis()),
                          (P.fieldGroupObj[a].isActualTimeout = !!t),
                          P.process(a)),
                          t && w.setState(a, !0);
                        var n = "";
                        e === v
      ...
      (d._getAudienceManagerURLData = function(e) {
        ...
        if (
          ...
          var c = "http" + (d.loadSSL ? "s" : "") + "://" + t + "/id",
            f =
              "d_visid_ver=" +
              d.version +
              (g && -1 !== c.indexOf("demdex.net")
            ...
            p = ["s_c_il", d._in, e];
          return (
            (n = c + "?" + f + "&d_cb=s_c_il%5B" + d._in + "%5D." + e),
            {
              url: n,
              corsUrl: c + "?" + f,
              callback: p
    ...
    var P = {
      d_timingapi: h.performance && h.performance.timing ? 1 : 0,
      performanceTiming:
        h.performance && h.performance.timing ? h.performance.timing : null,
      windowLoad: null,
      d_winload: null,
      fieldGroupObj: {},
      metricsQueue: [],
      send: function(e) {
        if (d.takeTimeoutMetrics && e === Object(e)) {
          var t,
            n,
            i = [],
        ...
        return (
          null == this.d_winload &&
            (this.performanceTiming
              ...
              : (this.d_winload = this.windowLoad - _.codeLoadEnd)),
          this.d_winload
        );
      },
      millis: function() {
      ...
      process: function(e) {
        ...
        (n.d_visid_stg_timeout_captured = t.d_visid_stg_timeout_captured),
          ...
          (n.d_visid_url = t.url),
          _.windowLoaded ? this.send(n) : this.metricsQueue.push(n),
    ...
    (d.isClientSideMarketingCloudVisitorID = function() {
      ...
      (function() {
        if (((d.configs = Object.create(null)), T.isObject(n)))
          for (var e in n) O(e) && ((d[e] = n[e]), (d.configs[e] = n[e]));
      })(),
      (function() {
        [
          ...
          !(function() {
            if (T.isObject(n)) {
              ...
              d.idSyncDisableSyncs ||
                d.disableIdSyncs ||
                !L.canMakeSyncIDCall(e, t) ||
                (d._setFieldExpire(A, -1), d._setField(I, t)),
            ...
            (function() {
              if (!d.idSyncDisableSyncs && !d.disableIdSyncs) {
                ...
                h.addEventListener("load", function() {
                  (_.windowLoaded = !0),
                    (P.windowLoad = P.millis()),
                    P.releaseMetricsQueue(),
                    e();
                });
                try {
                  $.receiveMessage(function(e) {
  ...
  return (
    (Fe.getInstance = function(e, t) {
      ...
      var r = e,
        a = r
          ...
          .join(""),
        o = new Fe(e, null, a);
      x.isObject(i) && i.cookieDomain && (o.cookieDomain = i.cookieDomain),
        (function() {
    ...
    (function() {
      ...
      m.addEventListener
        ...
        : m.attachEvent && m.attachEvent("onload", e),
