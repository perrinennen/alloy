...
var e = (function() {
  ...
  function f() {
    ...
    function t() {
      M(y),
        ...
        m.set(h.permissions, { optInCookieDomain: c, optInStorageExpiry: l }),
        C.execute(Ne);
    }
    function n(e) {
      return function(n, i) {
        ...
        return O(ce.CHANGED), Object.assign(y, be(ve(n), e)), i || t(), h;
      };
    }
    var i = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
      ...
      p = f.cookies,
      g = Le(a);
    Pe(g, "Invalid `previousPermissions`!"),
      Pe(o, "Invalid `preOptInApprovals`!");
    var m = u({ isEnabled: !!s, cookieName: "adobeujs-optin" }, { cookies: p }),
      h = this,
      _ = se(h),
      C = pe(),
      I = Oe(g),
      ...
      S = {},
      b = (function(e, t) {
        return Me(e) || (t && Me(t)) ? ce.COMPLETE : ce.PENDING;
      })(I, D),
      A = (function(e, t, n) {
        var i = be(fe, !r);
    ...
    var r = function(e) {
        ...
        o(function() {
          ...
          (arguments.length > 1 ? arguments[1] : void 0) &&
            ((s = { purposeConsents: r, gdprApplies: o, vendorConsents: c }),
            i("allConsentData", s)),
            a(function() {
              var e =
                arguments.length > 0 && void 0 !== arguments[0]
  ...
  var C,
    ...
    re = function(e, t) {
      ...
      return {
                    ...
                    return function() {
                      ...
                      if (c) {
                        ...
                        for (u = 0, d = o.length; u < d; u++)
                          (f = o[u]), f.match("^" + n.id + "-") || l.push(f);
                      }
                      s.setSyncTrackingData(l, n, i, r);
                    };
        ...
        canMakeSyncIDCall: function(t, n) {
          return (
            e._forceSyncIDCall || !t || n - t > ie.DAYS_BETWEEN_SYNC_ID_CALLS
          );
        },
    ...
    ue = ((C = {}), t(C, le.AAM, 565), t(C, le.ECID, 565), C),
    de = ((I = {}), t(I, le.AAM, [1, 2, 5]), t(I, le.ECID, [1, 2, 5]), I),
    fe = (function(e) {
  ...
  (f.Categories = le), (f.TimeoutError = d);
    ...
    Ve = {
      ...
      set: function(e, t, n) {
        ...
        if (r && "SESSION" !== i && "NONE" !== i) {
          ...
          if (c) (r = new Date()), r.setTime(r.getTime() + 1e3 * c);
          else if (1 === r) {
            r = new Date();
            var l = r.getYear();
  ...
  var Be = function(t, n, i) {
    ...
    function u() {
      return d.configs.isIabContext
        ? f.optIn.isApproved(f.optIn.Categories.ECID) && g
    ...
    (d.FIELDS = E.FIELDS),
      ...
      (d.setCustomerIDs = function(t) {
        ...
        if (!d.isOptedOut() && t) {
          ...
          (d._newCustomerIDsHash = String(d._hash(c))),
    ...
    (d._liberatedOptOut = null),
      ...
      (d._addQuerystringParam = function(e, t, n, i) {
        ...
        var s = o.split("?"),
          c = s[0] + "?",
          l = s[1];
        return c + L.addQueryParamAtLocation(l, r, i) + a;
      }),
      ...
      (d._readVisitor = function() {
        if (!d._readVisitorDone) {
          ...
          var e,
            ...
            s = !1,
            c = d.cookieRead(d.cookieName),
            l = new Date();
          if (
            (c ||
              m ||
              d.discardTrackingServerECID ||
              (c = d.cookieRead(ie.FIRST_PARTY_SERVER_COOKIE)),
      ...
      (d._setFields = function(t, n) {
        ...
        if (d.idSyncDisableSyncs || d.disableIdSyncs)
          ...
          var c = {};
          (c.ibs = n.ibs), (c.subdomain = n.subdomain), P.processIDCallData(c);
        }
        if (n === Object(n)) {
          var l, f;
          u() && d.isAllowed() && (l = d._getField("MCOPTOUT"));
          var p = j.parseOptOut(n, l, O);
          (l = p.optOut),
            (f = p.d_ottl),
      ...
      (d._getRemoteField = function(e, t, n, i, r) {
        ...
        if (u() && d.isAllowed()) {
          d._readVisitor(), (o = d._getField(e, !0 === c[e]));
          if (
            (function() {
              return (
        ...
        if (
          ...
          var u = "http" + (d.loadSSL ? "s" : "") + "://" + t + "/id",
            f =
              "d_visid_ver=" +
              d.version +
              (p && -1 !== u.indexOf("demdex.net")
                ? "&gdpr=1&gdpr_force=1&gdpr_consent=" + p
                : "") +
              "&d_rtbd=json&d_ver=2" +
                ...
                (d.configs.isIabContext
                  ? f.optIn.execute({
                      ...
                      callback: function(e, t) {
                        ...
                        t.gdprApplies && (p = t.consentString), d.init(), i();
                      }
                    })
                  : (d.init(), i()));
            },
            i = function() {
              f.optIn.off("complete", e);
            };
          return f.optIn.fetchPermissions(e, !0);
        }
        !(function() {
          if (L.isObject(n)) {
