function AppMeasurement_Module_AudienceManagement(d) {
  ...
  a.setup = function(b) {
    c.DIL &&
      b &&
      ((b.disableDefaultRequest = !0),
      (b.disableScriptAttachment = !0),
      (b.disableCORS = !0),
      (b.secureDataCollection = !1),
      (a.instance = c.DIL.create(b)),
      (a.tools = c.DIL.tools),
      a.f());
  };
  a.f = function() {
    ...
    b &&
      b.isIabContext &&
      a.instance &&
      a.instance.api.getEventCallIabSignals({
        callback: function(b) {
          b && ((a.g = b.gdpr), (a.c = b.gdpr_consent));
        },
        timeout: 250
      });
  };
  a.i = function() {
    var b = d.contextData;
    a.c &&
      ((b["cm.iab.consent"] = a.c),
      (b["cm.gdpr"] = a.g),
      d.e() || delete b["cm.ssf"]);
  };
  a.e = function() {
    var b = a.a();
    return b && !b.isApproved(b.Categories.AAM) ? !1 : !0;
  };
  a.a = function() {
  ...
  "function" != typeof window.DIL &&
    ((window.DIL = function(n) {
      ...
      n !== Object(n) && (n = {}),
        ...
        (a =
          void 0 === n.secureDataCollection || !0 === n.secureDataCollection),
      ...
      C.IS_IE_LESS_THAN_10 =
        "number" == typeof C.IE_VERSION && C.IE_VERSION < 10;
      var S = { stuffed: {} },
        D = {},
        _ = {
          firingQueue: [],
          ...
          adms: {
            ...
            releaseRequests: function() {
              (this.calledBack = !0), _.registerRequest();
            },
      ...
      var R,
        ...
        L = {
          traits: function(e) {
            return (
              q.isValidPdata(e) &&
                (D.sids instanceof Array || (D.sids = []),
                A.extendArray(D.sids, e)),
              this
            );
          },
          pixels: function(e) {
            return (
              q.isValidPdata(e) &&
                (D.pdata instanceof Array || (D.pdata = []),
                A.extendArray(D.pdata, e)),
              this
            );
          },
          logs: function(e) {
          ...
          customQueryParams: function(e) {
            return (
              q.isEmptyObject(e) || A.extendObject(D, e, _.reservedKeys), this
            );
          },
          signals: function(e, t) {
            ...
            if (!q.isEmptyObject(s)) {
              ...
              A.extendObject(D, s, _.reservedKeys);
            }
            return this;
          },
          declaredId: function(e) {
            return _.declaredId.setDeclaredId(e, "request"), this;
          },
          result: function(e) {
          ...
          submit: function(e) {
            return (
              (D.isDefaultRequest = !!e), P.submitRequest(D), (D = {}), this
            );
          },
          getPartner: function() {
            return I;
          ...
          getState: function() {
            var e = {},
              t = {};
            return (
              A.extendObject(e, _, { registerRequest: !0 }),
              A.extendObject(t, E, {
                requestToProcess: !0,
                process: !0,
                sendMessages: !0
        ...
        P = {
          ...
          submitRequest: function(e) {
            return _.registerRequest(P.createQueuedRequest(e)), !0;
          },
          createQueuedRequest: function(e) {
            ...
            if ((delete e.isDefaultRequest, !q.isEmptyObject(u)))
              for (s in u)
                if (u.hasOwnProperty(s)) {
                  ...
                  if (s in e && !(i in e) && !(i in _.reservedKeys)) {
            ...
            return (
              ...
              (e.logdataArray = A.convertObjectToKeyValuePairs(
                e.logdata,
                "=",
                !0
              )),
          ...
          defaultCallback: function(e, t) {
            ...
            if ((n = e.stuff) && n instanceof Array && (s = n.length))
              for (i = 0; i < s; i++)
                (r = n[i]) &&
                  ...
                  (void 0 !== (d = r.ttl) && "" !== d) ||
                    (d = Math.floor(
                      A.getMaxCookieExpiresInMinutes() / 60 / 24
                    )),
            ...
            q.isPopulatedString(p) &&
              ...
              _.abortRequests || E.requestToProcess(e, t);
          },
          ...
          handleCORSError: function(e, t, n) {
            _.num_of_cors_errors++, _.corsErrorSources.push(n);
          },
      ...
      var N = !1,
        F = function() {
          N || ((N = !0), _.registerRequest(), Q());
        },
        Q = function() {
          setTimeout(function() {
            l ||
              _.firstRequestHasFired ||
              ("function" == typeof f
                ? L.afterResult(f).submit(!0)
                : L.submit(!0));
      ...
      "error" !== I &&
        (DIL.windowLoaded
          ...
          : ((DIL.windowLoaded = !0), F())),
        _.declaredId.setDeclaredId(s, "init"),
        j.init(),
        x.init(),
        _.processVisitorAPI();
      C.IS_IE_LESS_THAN_10 &&
        A.replaceMethodsWithFunction(L, function() {
          return this;
        }),
        (this.api = L),
        ...
        (this.requestController = _),
        (this.destinationPublishing = E),
        (this.requestProcs = P),
        (this.units = b),
        O && ((this.variables = S), (this.callWindowLoadFunctions = F));
    }),
