...
function AppMeasurement(r) {
  ...
  a.delayReady = function() {
    var c = new Date().getTime(),
      b = 0,
      d;
    for (a.o("_d") ? (b = 1) : a.ya(); 0 < a.L.length; ) {
      d = a.L.shift();
      if (b && !d.t && d.t > c) {
        a.L.unshift(d);
  ...
  a.Hb = function() {
    ...
    if (a.lightProfileID)
      (b = a.P),
        (q = a.lightTrackVars) && (q = "," + q + "," + a.ja.join(",") + ",");
    else {
      b = a.g;
      if (a.pe || a.linkType)
        (q = a.linkTrackVars),
          ...
          a.pe &&
            ((e = a.pe.substring(0, 1).toUpperCase() + a.pe.substring(1)),
            a[e] && ((q = a[e].Vb), (m = a[e].Ub)));
      q && (q = "," + q + "," + a.G.join(",") + ",");
      m && ((m = "," + m + ","), q && (q += ",events,"));
      a.events2 && (n += ("" != n ? "," : "") + a.events2);
    }
    if (r && a.wa() && r.getCustomerIDs) {
      e = p;
    ...
    for (d = 0; d < b.length; d++) {
      ...
      g ||
        ("events" == e && n
          ? ((g = n), (n = ""))
          : "marketingCloudOrgID" == e && r && (g = r.marketingCloudOrgID));
  ...
  a.C = function(a) {
    ...
    if (
      "undefined" != "" + a.$b ||
      ("undefined" != "" + a.Qb && "HTML" != ("" + a.Qb).toUpperCase())
    )
      return "";
  ...
  a.Ib = function() {
    ...
    b &&
      ...
      (c = 1));
    a.abort && (c = 0);
    if (a.trackClickMap || a.trackInlineStats || a.Lb()) {
      var b = {},
        d = 0,
        e = a.cookieRead("s_sq"),
        g = e ? e.split("&") : 0,
    ...
    if (!d) {
      ...
      try {
        Object.defineProperty
          ? Object.defineProperty(d, "onLoad", { get: d.hb, set: d.rb })
          : (d._olc = 1);
      } catch (f) {
        d._olc = 1;
      }
  ...
  a.R = function(c, b) {
    var d, f, e, g, h, l;
    for (d = 0; 2 > d; d++)
      for (f = 0 < d ? a.Ba : a.g, e = 0; e < f.length; e++)
        if (((g = f[e]), (h = c[g]) || c["!" + g])) {
  ...
  a.isReadyToTrack = function() {
    var c = !0;
    if (!a.lb() || !a.kb()) return !1;
    a.wa() || (c = !1);
    a.nb() || (c = !1);
    return c;
  };
  a.lb = function() {
    a.aa || a.J || (a.ab(a.tb) ? (a.J = !0) : (a.aa = !0));
    return a.aa && !a.J ? !1 : !0;
  };
  a.kb = function() {
    var c = a.ua();
    if (c)
      ...
      else return c.fetchPermissions(a.pb, !0), (a.Z = !0), !1;
    return !0;
  };
  a.V = function(c) {
    var b = a.ua();
  ...
  a.wa = function() {
    ...
    return c &&
      ...
      (a.ba ||
        ...
        !c.getVisitorValues ||
        ((a.ba = !0),
        a.marketingCloudVisitorID ? (a.S = !0) : c.getVisitorValues(a.ub)),
      a.ba && !a.S && !a.marketingCloudVisitorID)
      ? !1
      : !0;
  };
  a.T = function() {
  ...
  a.H = function() {
    var c;
    if (a.isReadyToTrack() && (a.sb(), a.l != p))
      for (; 0 < a.l.length; ) (c = a.l.shift()), c.xb.apply(c.yb, c.vb);
  };
  a.sb = function() {
  ...
  a.U = function() {
    if (a.p && (a.A && a.A.complete && a.A.F && a.A.qa(), a.p)) return;
    a.La = p;
    if (a.ma) a.ha > a.O && a.Sa(a.i), a.pa(500);
    else {
      var c = a.wb();
      if (0 < c) a.pa(c);
      else if ((c = a.Ha())) (a.p = 1), a.Ob(c), a.Rb(c);
    }
  };
  a.pa = function(c) {
    a.La || (c || (c = 0), (a.La = setTimeout(a.U, c)));
  };
  a.wb = function() {
    var c;
  ...
  a.Rb = function(c) {
    ...
    a.va() &&
      2047 < c.length &&
      (a.Za() && ((d = 1), (b = new XMLHttpRequest())),
      b &&
        ((a.AudienceManagement && a.AudienceManagement.isReady()) ||
          0 != a.usePostbacks) &&
        (a.X ? (b.Ca = !0) : (b = 0)));
    !b && a.Va && (c = c.substring(0, 2047));
    !b &&
      a.d.createElement &&
      (0 != a.usePostbacks ||
        (a.AudienceManagement && a.AudienceManagement.isReady())) &&
    ...
    b.onload = b.qa = function() {
      b.Ra && (a.ia = Date.now() - b.Ra);
      a.cb(c);
      b.Ea();
      a.Ab();
      a.ca();
    ...
    b.onabort = b.onerror = b.Ia = function() {
      b.Ea();
      (a.trackOffline || a.ma) && a.p && a.i.unshift(a.zb);
      a.p = 0;
      a.ha > a.O && a.Sa(a.i);
      a.ca();
      a.pa(500);
    ...
    b.onreadystatechange = function() {
      4 == b.readyState && (200 == b.status ? b.qa() : b.Ia());
    };
    a.Qa = a.B();
    if (1 == d)
      (f = c.indexOf("?")),
    ...
    b.F = setTimeout(function() {
      b.F &&
        (b.complete
          ? b.qa()
          : (a.trackOffline && b.abort && b.abort(), b.Ia()));
    }, 5e3);
    a.zb = c;
  ...
  a.Ab = function() {
    if (a.na() && !(a.Pa > a.O))
      try {
        k.localStorage.removeItem(a.la()), (a.Pa = a.B());
      } catch (c) {}
  };
  a.Sa = function(c) {
    if (a.na()) {
      a.Ua();
      try {
        k.localStorage.setItem(a.la(), k.JSON.stringify(c)), (a.O = a.B());
      } catch (b) {}
    }
  };
  a.Ua = function() {
    if (a.trackOffline) {
      ...
      for (; a.i.length > a.offlineLimit; ) a.Ha();
    }
  };
  ...
  a.P = a.ja.slice(0);
  a.Ba = "account allAccounts debugTracking visitor visitorOptedOut trackOffline offlineLimit offlineThrottleDelay offlineFilename usePlugins doPlugins configURL visitorSampling visitorSamplingGroup linkObject clickObject linkURL linkName linkType trackDownloadLinks trackExternalLinks trackClickMap trackInlineStats linkLeaveQueryString linkTrackVars linkTrackEvents linkDownloadFileTypes linkExternalFilters linkInternalFilters useForcedLinkTracking forcedLinkTrackingTimeout trackingServer trackingServerSecure ssl abort mobile dc lightTrackVars maxDelay expectSupplementalData usePostbacks registerPreTrackCallback registerPostTrackCallback AudienceManagement".split(
    " "
  );
  for (m = 0; 250 >= m; m++)
  ...
  a.ca = function() {
    a.da && (k.clearTimeout(a.da), (a.da = p));
          ...
          if (
            ...
            if (a.Da)
              if (a.useForcedLinkTracking)
                ...
                a.Da = a.useForcedLinkTracking = 0;
                return;
              }
            ...
            try {
              if (
                ...
                f = a.Ka();
                a.track();
                if (f < a.Ka() && a.useForcedLinkTracking && c.target) {
                  for (
                    e = c.target;
                    e &&
                    e != a.b &&
