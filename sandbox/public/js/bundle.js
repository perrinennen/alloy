/**
 * @license
 * Adobe Visitor API for JavaScript version: 3.3.38
...
var Visitor = (function() {
  ...
  var LocalVisitor = function LocalVisitor(generateRandomID) {
    ...
    function makeFallback(key, callback) {
      ...
      return function() {
        var randomMid = generateRandomID(0, STATE_KEYS_MAP$1.MCMID);
        var state = {};
        state[STATE_KEYS_MAP$1.MCMID] = randomMid;
  ...
  var ChildVisitor = function ChildVisitor(
    ...
    function setStrategyVisitor(strategy) {
      Object.assign(childVisitor, strategy);
    }
    ...
    function implementAPI() {
      ...
      childVisitor.getSupplementalDataID = visitor.getSupplementalDataID;
    }
  ...
  var getDomain = function getDomain(hostname) {
    ...
    if (domain) {
      if (!/^[0-9.]+$/.test(domain)) {
        var domain2CharExceptions =
          ",ac,ad,ae,af,ag,ai,al,am,an,ao,aq,ar,as,at,au,aw,ax,az,ba,bb,be,bf,bg,bh,bi,bj,bm,bo,br,bs,bt,bv," +
          "bw,by,bz,ca,cc,cd,cf,cg,ch,ci,cl,cm,cn,co,cr,cu,cv,cw,cx,cz,de,dj,dk,dm,do,dz,ec,ee,eg,es,et,eu,fi,fm,fo,fr,ga,gb,gd," +
          "ge,gf,gg,gh,gi,gl,gm,gn,gp,gq,gr,gs,gt,gw,gy,hk,hm,hn,hr,ht,hu,id,ie,im,in,io,iq,ir,is,it,je,jo,jp,kg,ki,km,kn,kp,kr," +
          "ky,kz,la,lb,lc,li,lk,lr,ls,lt,lu,lv,ly,ma,mc,md,me,mg,mh,mk,ml,mn,mo,mp,mq,mr,ms,mt,mu,mv,mw,mx,my,na,nc,ne,nf,ng,nl," +
          "no,nr,nu,nz,om,pa,pe,pf,ph,pk,pl,pm,pn,pr,ps,pt,pw,py,qa,re,ro,rs,ru,rw,sa,sb,sc,sd,se,sg,sh,si,sj,sk,sl,sm,sn,so,sr," +
          "st,su,sv,sx,sy,sz,tc,td,tf,tg,th,tj,tk,tl,tm,tn,to,tp,tr,tt,tv,tw,tz,ua,ug,uk,us,uy,uz,va,vc,ve,vg,vi,vn,vu,wf,ws,yt,";
        var domainPartList = domain.split(".");
        var domainPartNum = domainPartList.length - 1;
        var domainTargetPartNum = domainPartNum - 1; // Take care of two part top level domains like .co.uk
        // The rule is:
        ...
        if (
          domainPartNum > 1 &&
          domainPartList[domainPartNum].length <= 2 &&
          (domainPartList[domainPartNum - 1].length === 2 ||
            domain2CharExceptions.indexOf(
              "," + domainPartList[domainPartNum] + ","
            ) < 0)
        ) {
          domainTargetPartNum--;
        }
        ...
        if (domainTargetPartNum > 0) {
          ...
          while (domainPartNum >= domainTargetPartNum) {
            domain =
              domainPartList[domainPartNum] + (domain ? "." : "") + domain;
            domainPartNum--;
          }
        }
      } else {
  ...
  var VENDOR_IDS =
    ((_VENDOR_IDS = {}),
    _defineProperty(_VENDOR_IDS, CATEGORIES.AAM, 265),
    _defineProperty(_VENDOR_IDS, CATEGORIES.ECID, 265),
    _VENDOR_IDS);
  var CATEGORY_PURPOSES =
    ((_CATEGORY_PURPOSES = {}),
    _defineProperty(_CATEGORY_PURPOSES, CATEGORIES.AAM, [1, 2, 5]),
    _defineProperty(_CATEGORY_PURPOSES, CATEGORIES.ECID, [1, 2, 5]),
    _CATEGORY_PURPOSES);
  ...
  var handleInvalidPermissions = function handleInvalidPermissions(
    ...
    if (!areValidPermissions(permissions)) {
      ...
      throw new Error("[OptIn] ".concat(errorMsg));
    }
  };
  ...
  var makeCommand = function makeCommand(plugins) {
    return function() {
      ...
      try {
        ...
        throw new Error("[OptIn.execute] Something went wrong: " + ex.message);
      }
    };
  };
  ...
  function OptIn() {
    ...
    var cookieApprovalsObj = storage.get();
    var plugins = {};
  ...
  var throwIfNoCmp = function throwIfNoCmp() {
  ...
  function IAB() {
    ...
    var registry = callbackRegistryFactory$1();
    var state = {
      allConsentData: null // `gdprApplies`-`purposesConsent`-`vendorConsents`-`consentString`.
    };
    ...
    self.isApproved = function(_ref2) {
      ...
      var callbackWithTimer = makeTimedCallback(function(error) {
        var _ref3 =
            arguments.length > 1 && arguments[1] !== undefined
              ? arguments[1]
              : {},
          vendorConsents = _ref3.vendorConsents,
          purposeConsents = _ref3.purposeConsents;

        callback(error, isApproved(category, vendorConsents, purposeConsents));
      }, timeout);
      fetchConsentData({
        category: category,
        callback: callbackWithTimer
    ...
    self.onRegister = function(optIn) {
      ...
      var allVendors = Object.keys(VENDOR_IDS);
      ...
      var callback = function callback(error) {
        var _ref4 =
          ...
          gdprApplies = _ref4.gdprApplies,
          vendorConsents = _ref4.vendorConsents;

        if (!error && gdprApplies && vendorConsents && purposeConsents) {
          allVendors.forEach(function(vendor) {
            var isVendorApproved = isApproved(
              vendor,
              vendorConsents,
              purposeConsents
            );
    ...
    // - `gdprApplies`, `purposesConsent`, `vendorConsents`, `consentString` and `allConsentData`.
    // - It should call __cmp.getConsentData & __cmp.getVendorConsents, and aggregate the responses.

    var fetchConsentData = function fetchConsentData(_ref5) {
      ...
      getVendorConsents(function() {
        var _ref6 =
            arguments.length > 0 && arguments[0] !== undefined
              ? arguments[0]
              : {},
          purposeConsents = _ref6.purposeConsents,
          gdprApplies = _ref6.gdprApplies,
          vendorConsents = _ref6.vendorConsents;
        ...
        getConsentData(function() {
          ...
          registry.execute(FETCH_CONSENT_KEY, [null, state.allConsentData]);
        });
      });
    };

    var getConsentData = function getConsentData(callback) {
      // 'null' means get the latest version of the consent string.
      __cmp("getConsentData", null, callback);
    };

    var getVendorConsents = function getVendorConsents(callback) {
    ...
    var isApproved = function isApproved(category) {
      var vendorConsents =
        arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var purposeConsents =
        arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
      var isVendorApproved = !!vendorConsents[VENDOR_IDS[category]];

      var arePurposesApproved = function arePurposesApproved() {
        return CATEGORY_PURPOSES[category].every(function(purpose) {
          return purposeConsents[purpose];
        });
      };
  ...
  var Visitor = function Visitor(
    ...
    function populateIdsFrom(adobeMcParam) {
      ...
      setIdIfValid(adobeMcParam[MCMID], visitor.setMarketingCloudVisitorID);
      ...
      if (server) {
        ...
        var queryData =
          ...
          (CONSENT_STRING && baseUrl.indexOf("demdex.net") !== -1
            ? "&gdpr=1&gdpr_force=1&gdpr_consent=" + CONSENT_STRING
            : "") +
          "&d_rtbd=json" +
          "&d_ver=2" +
    ...
    visitor.publishDestinations = function(subdomain, messages, callback) {
    ...
    function shouldWaitForOptIn() {
      console.log(
        visitor.configs.doesOptInApply,
        adobe.optIn.isComplete,
        isOptInSafe()
      );
      debugger;
      return !!(
    ...
    visitor.init = function() {
      ...
      if (shouldWaitForOptIn()) {
        var unsubscribe = adobe.optIn.fetchPermissions(function() {
          // TODO: Set the status in the AMCV cookie?
          if (adobe.optIn.isApproved(adobe.optIn.Categories.ECID)) {
            if (visitor.configs.isIabContext) {
              // Retrieve `gdpr` and `gdpr_consent` from plugin:
              adobe.optIn.execute({
                command: "iabPlugin.fetchConsentData",
                callback: function callback(error, consent) {
  ...
  Visitor_1.getInstance = function(marketingCloudOrgID, initConfig) {
    ...
    } // Parse and normalize initConfig.

    function parseInitConfig() {
      if (!utils.isObject(initConfig)) {
        return;
      }

      return Object.keys(initConfig).reduce(function(configs, key) {
        // TODO: Clean this up by adding a normalize to configs items in visitorConfig.
        var normalized =
          key !== "doesOptInApply"
            ? initConfig[key]
            : !!visitorConfig.normalizeConfig(initConfig[key]);
    ...
    function setupOptIn(configs) {
      function instantiateOptIn() {
        ...
        if (optInConfig.isIabContext) {
          var iabPlugin = new IabPlugin(window.__cmp);
    ...
    var normalizedInitConfig = parseInitConfig();
